// Puerto 1:1 de references/started-games/02-asteroids/game.js a TypeScript.
// Los "globals" del original (ship, bullets, asteroids, score, keys, etc.)
...
export class RocasEngine {
  ...
  destroy(): void {
    // El motor no registra listeners propios (los engancha el hook en window),
    // no hay nada que limpiar internamente por ahora.
  }
}
